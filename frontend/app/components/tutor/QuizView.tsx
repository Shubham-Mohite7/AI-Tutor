              ...
              {q.options.map((opt) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left w-full px-4 py-3 rounded-xl text-[14px] font-medium border transition-all duration-150 ${
                      selected
                        ? "border-brand-500 bg-gradient-to-r from-brand-100 to-brand-50 text-brand-700 font-semibold"
                        : "border-brand-200 bg-brand-50 text-slate-600 hover:border-brand-400 hover:bg-brand-100 hover:text-slate-800"
                    }`}
                  >
                    {opt}
                  </button>
