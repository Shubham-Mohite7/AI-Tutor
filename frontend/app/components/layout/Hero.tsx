    ...
    <section className="w-full bg-white border-b border-brand-200 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-12 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative z-10">
          <span className="inline-flex items-center bg-brand-100 border border-brand-200 rounded-full px-4 py-1.5 text-[11px] font-bold text-brand-500 uppercase tracking-widest mb-5">
          ...
          <div className="flex flex-wrap gap-2.5">
            {pills.map((p) => (
              <span key={p} className="text-[12px] font-semibold text-brand-600 bg-brand-100 border border-brand-200 rounded-full px-4 py-1.5">
                {p}
              </span>
            ))}
          </div>
